...
$lang['manage_customers_hint'] = 'Gerenciar os pacientes e visualizar o seu histórico.';
...
$lang['customer_deleted'] = 'Paciente excluído com sucesso.';
...
$lang['edit_working_plan_hint'] = 'Marque os dias e as horas a que a sua empresa aceita agendamentos. Assim será possível agendamentos em horário de atendimento, evitando que os cacientes marquem agendamento fora do horário de atendimento. Este plano de trabalho será o padrão para cada novo registo de atendente, mas é possível mudar o plano de cada fornecedor separadamente editando o atendente. Depois disso, pode adicionar períodos de descanso.';
...
$lang['book_advance_timeout_hint'] = 'Definir o limite de tempo (em minutos) antes que os cacientes possam reservar ou reorganizar agendamentos com a empresa.';
$lang['timeout_minutes'] = 'O tempo acaba (minutos)';
$lang['about_app_info'] = 'Easy! Appointmentes é uma aplicação web altamente personalizável que permite que os pacientes marquem eventos através da internet. Além disso, oferece a possibilidade de sincronizar seus dados com o Google Calendar para que possa usá-los com outros serviços.';
...
$lang['require_captcha_hint'] = 'Quando habilitado, os pacientes terão que digitar um código CAPTCHA gerado randomicamente antes de cadastrar/atualizar um agendamento.';
...
$lang['customer_notifications'] = 'Notificações de pacientes';
$lang['customer_notifications_hint'] = 'Define se o paciente receberá ou não, notificações por email sempre que um de seus agendamentos sejam alterados de horário.';
...
$lang['require_phone_number_hint'] = 'Quando ativado, os pacientes e usuários precisarão inserir o número de telefone do paciente ao reservar um compromisso';
...
$lang['display_any_provider_hint'] = 'A página de reserva terá uma opção adicional que permite aos pacientes fazerem a reserva sem especificar um fornecedor.';
...
$lang['disable_booking_hint'] = 'A página de reservas será desativada enquanto esta configuração estiver ativa e os pacientes não poderão agendar novos compromissos.';
...
$lang['limit_customer_access_hint'] = 'Se ativado, provedores e secretárias só poderão acessar pacientes com os quais tenham um compromisso.';
$lang['url'] = 'URL';
...
$lang['webhooks_info'] = 'Os Webhooks permitem enviar notificações HTTP para aplicativos externos em resposta a vários eventos do aplicativo, como a criação de um compromisso ou a remoção de um paciente.';
...
$lang['future_booking_limit_hint'] = 'Defina o limite futuro em dias que os pacientes podem fazer reservas via a página pública de reservas.';
...
$lang['customer_is_already_booked'] = 'Este paciente já tem um compromisso durante o período de reserva solicitado.';
$lang['fields'] = 'Campos';
